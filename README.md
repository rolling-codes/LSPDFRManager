...
[![Release](https://img.shields.io/badge/release-v3.7.14-blue.svg)](https://github.com/rolling-codes/LSPDFRManager/releases/latest)
...
Download `LSPDFRManager-v3.7.14-win-x64.zip` from [Releases](https://github.com/rolling-codes/LSPDFRManager/releases/latest), extract anywhere, and run `LSPDFRManager.exe`. No installer needed.
