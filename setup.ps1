...
Write-Host "LSPDFRManager v3.6.1 Setup" -ForegroundColor Cyan
Write-Host "==========================`n"

$packageDirName = "LSPDFRManager-v3.6.1"
$installParent = $env:ProgramFiles
$installDir = Join-Path $installParent $packageDirName
$exeZipUrl = "https://github.com/rolling-codes/LSPDFRManager/releases/download/v3.6.1/LSPDFRManager-v3.6.1-win-x64.zip"
$exeZipPath = "$env:TEMP\LSPDFRManager-v3.6.1-win-x64.zip"
